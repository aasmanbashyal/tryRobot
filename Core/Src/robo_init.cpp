...
{
	// 2.6
	gMotor[0].setPID_constraints(1.9, 42, 0.00, 65, -65);  //2,38,
	gMotor[1].setPID_constraints(1.78, 40, 0.00, 65, -65); //1.74,45
	gMotor[2].setPID_constraints(1.50, 45, 0.00, 65, -65); //1.5,55
